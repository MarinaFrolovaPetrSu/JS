...
ymaps.ready(async () => {
  ...
  const customBalloonTemplate = document.getElementById('customBalloonTemplate')
    .innerHTML;
  const customClustererItemLayout = document.getElementById('customClustererItemLayout')
    .innerHTML;
  ...
  const clustererItemLayout = ymaps.templateLayoutFactory.createClass(
    customClustererItemLayout
  );
